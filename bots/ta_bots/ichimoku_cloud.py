...
from strategies.ta_indicators.ichimoku_cloud import IchimokuCloudStrategy

from exit_rules.trading_exit_rules import ExitRules


class IchimokuCloudBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
                 ...
                 conversion_window_ichimoku=9,
                 base_window_ichimoku=26,
                 span_window_ichimoku=52,
                 leading_shift_ichimoku=26,
                 lagging_shift_ichimoku=26,
        ...
        # Ichimoku Cloud Strategy
        self.conversion_window_ichimoku = conversion_window_ichimoku
        self.base_window_ichimoku = base_window_ichimoku
        self.span_window_ichimoku = span_window_ichimoku
        self.leading_shift_ichimoku = leading_shift_ichimoku
        self.lagging_shift_ichimoku = lagging_shift_ichimoku
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "ichimoku_cloud":
            # Strategy
            trading_strategy = IchimokuCloudStrategy(data)
            data = trading_strategy.ichimoku_cloud(conversion_window=self.conversion_window_ichimoku,
                                                   base_window=self.base_window_ichimoku,
                                                   span_window=self.span_window_ichimoku,
                                                   leading_shift=self.leading_shift_ichimoku,
                                                   lagging_shift=self.lagging_shift_ichimoku)
