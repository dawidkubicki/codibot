...
class RSIDiveergenceBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
        ...
        self.frame_rsi = frame_rsi
        self.K_rsi = K_rsi
        self.ema_s_rsi = ema_s_rsi
        self.ema_m_rsi = ema_m_rsi
        self.rsi_small_rsi = rsi_small_rsi
        self.rsi_big_rsi = rsi_big_rsi
        self.lags_rsi = lags_rsi
        self.divergence_regular_rsi = divergence_regular_rsi
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "rsi_divergence":
            # Strategy
            trading_strategy = RSIDivergenceStrategy(data)
            data = trading_strategy.rsi(window=self.window_rsi,
                                        frame=self.frame_rsi,
                                        K=self.K_rsi,
                                        ema_s=self.ema_s_rsi,
                                        ema_m=self.ema_m_rsi,
                                        rsi_small=self.rsi_small_rsi,
                                        rsi_big=self.rsi_big_rsi,
                                        lags=self.lags_rsi,
                                        divergence_regular=self.divergence_regular_rsi)
