...
class EMACrossoverBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "double_ema":
            # Strategy
            trading_strategy = EMAStrategy(data)
            data = trading_strategy.double_ema(self.EMA_S, self.EMA_L)

        elif self.strategy_type == "triple_ema":
            # Strategy
            trading_strategy = EMAStrategy(data)
            data = trading_strategy.triple_ema(self.EMA_S, self.EMA_M, self.EMA_L)
