...
class SMACrossoverBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "double_sma":
            # Strategy
            trading_strategy = SMAStrategy(data)
            data = trading_strategy.double_sma(self.SMA_S, self.SMA_L)

        elif self.strategy_type == "triple_sma":
            # Strategy
            trading_strategy = SMAStrategy(data)
            data = trading_strategy.triple_sma(self.SMA_S, self.SMA_M, self.SMA_L)
