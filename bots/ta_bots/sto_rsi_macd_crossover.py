...
class STORSIMACDCrossoverBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
                 ...
                 k_period_sto_rsi_macd=14,
                 smoothing_k_sto_rsi_macd=3,
                 d_period_sto_rsi_macd=3,
                 ema_fast_sto_rsi_macd=12,
                 ema_slow_sto_rsi_macd=26,
                 ema_sign_sto_rsi_macd=9,
                 rsi_window_sto_rsi_macd=14,
                 lags_sto_rsi_macd=4,
                 shift_position_sto_rsi_macd=1
        ...
        # Stochastic RSI MACD Strategy
        self.k_period_sto_rsi_macd = k_period_sto_rsi_macd
        self.smoothing_k_sto_rsi_macd = smoothing_k_sto_rsi_macd
        self.d_period_sto_rsi_macd = d_period_sto_rsi_macd
        self.ema_fast_sto_rsi_macd = ema_fast_sto_rsi_macd
        self.ema_slow_sto_rsi_macd = ema_slow_sto_rsi_macd
        self.ema_sign_sto_rsi_macd = ema_sign_sto_rsi_macd
        self.rsi_window_sto_rsi_macd = rsi_window_sto_rsi_macd
        self.lags_sto_rsi_macd = lags_sto_rsi_macd
        self.shift_position_sto_rsi_macd = shift_position_sto_rsi_macd
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "sto_rsi_macd":
            # Strategy
            trading_strategy = STORSIMACDStrategy(data)
            data = trading_strategy.sto_rsi_macd(k_period=self.k_period_sto_rsi_macd,
                                                 smoothing_k=self.smoothing_k_sto_rsi_macd,
                                                 d_period=self.d_period_sto_rsi_macd,
                                                 ema_fast=self.ema_fast_sto_rsi_macd,
                                                 ema_slow=self.ema_slow_sto_rsi_macd,
                                                 ema_sign=self.ema_sign_sto_rsi_macd,
                                                 rsi_window=self.rsi_window_sto_rsi_macd,
                                                 lags=self.lags_sto_rsi_macd,
                                                 shift_position=self.shift_position_sto_rsi_macd)
