...
class IchimokuCloudRSIBOT(BinanceClient, TimeOperator):
    def __init__(self,
                 key: str,
                 secret: str,
                 use_testnet: bool,
                 ...
                 conversion_window_ichimoku_rsi=9,
                 base_window_ichimoku_rsi=26,
                 span_window_ichimoku_rsi=52,
                 leading_shift_ichimoku_rsi=26,
                 lagging_shift_ichimoku_rsi=26,
                 ichimoku_rsi_window=14,
                 ichimoku_rsi_ema_window=200,
        ...
        # Ichimoku Cloud RSI Strategy
        self.conversion_window_ichimoku_rsi = conversion_window_ichimoku_rsi
        self.base_window_ichimoku_rsi = base_window_ichimoku_rsi
        self.span_window_ichimoku_rsi = span_window_ichimoku_rsi
        self.leading_shift_ichimoku_rsi = leading_shift_ichimoku_rsi
        self.lagging_shift_ichimoku_rsi = lagging_shift_ichimoku_rsi
        self.ichimoku_rsi_window = ichimoku_rsi_window
        self.ichimoku_rsi_ema_window = ichimoku_rsi_ema_window
    ...
    def define_strategy(self):
        ...
        if self.strategy_type == "ichimoku_cloud_rsi":
            # Strategy
            trading_strategy = IchimokuCloudRSIStrategy(data)
            data = trading_strategy.ichimoku_cloud_rsi(conversion_window=self.conversion_window_ichimoku_rsi,
                                                       base_window=self.base_window_ichimoku_rsi,
                                                       span_window=self.span_window_ichimoku_rsi,
                                                       leading_shift=self.leading_shift_ichimoku_rsi,
                                                       lagging_shift=self.lagging_shift_ichimoku_rsi,
                                                       rsi_window=self.ichimoku_rsi_window,
                                                       ema_window=self.ichimoku_rsi_ema_window)
